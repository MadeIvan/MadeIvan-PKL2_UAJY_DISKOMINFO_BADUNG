...
<body class="min-h-screen bg-slate-100 text-slate-900">
        ...
        <div class="flex h-full items-center justify-between px-4 lg:px-6">
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    ...
                    <span class="hidden sm:inline">Simpan Tutorial</span>
                </button>
                ...
                <button type="button" class="flex items-center gap-3 rounded-xl px-2 py-1.5 transition hover:bg-slate-100">
    ...
    >
        <div class="p-5">
            ...
            <p class="mb-3 px-3 text-xs font-semibold uppercase tracking-wider text-slate-400">Menu Utama</p>

            <nav class="space-y-1">
                <a href="{{ url('/admin/dashboard') }}" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
                    <i class="bi bi-grid text-lg"></i>
                    Dashboard
                </a>

                <a href="/content-index" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
                    <i class="bi bi-journal-text text-lg"></i>
                    Daftar Pengetahuan
                </a>

                <a href="/" class="flex items-center gap-3 rounded-xl bg-blue-50 px-3 py-3 text-sm font-semibold text-blue-900">
                    <i class="bi bi-plus-square text-lg"></i>
                    Tambah Pengetahuan
                </a>

                <a href="{{ url('/admin/kategori') }}" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
                    <i class="bi bi-folder2-open text-lg"></i>
                    Kategori
                </a>

                <a href="{{ url('/admin/aplikasi') }}" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
            ...
            <nav class="space-y-1">
                <a href="{{ url('/admin/pengguna') }}" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
                    <i class="bi bi-people text-lg"></i>
                    Pengguna
                </a>

                <a href="{{ url('/admin/media') }}" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
                    <i class="bi bi-images text-lg"></i>
                    Media
                </a>

                <a href="{{ url('/admin/log-aktivitas') }}" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
            ...
            <nav class="space-y-1">
                <a href="{{ url('/admin/pengaturan') }}" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-100 hover:text-blue-900">
                    <i class="bi bi-gear text-lg"></i>
                    Pengaturan
                </a>

                <a href="#" class="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-medium text-red-600 transition hover:bg-red-50">
    ...
    <main class="pt-20 lg:pl-72">
        <div class="mx-auto max-w-7xl px-5 py-8 lg:px-8">
            <nav class="mb-5 flex items-center gap-2 text-sm text-slate-500">
                ...
                <i class="bi bi-chevron-right text-xs"></i>
                <span class="font-medium text-slate-800">Tambah Tutorial</span>
            </nav>
            ...
            <div class="space-y-6">
                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        Isi informasi dasar tutorial sebelum menambahkan konten.
                    </p>
                            ...
                            <label class="flex items-start gap-3">
                                ...
                                <span>
                                    ...
                                    <span class="block text-xs text-slate-500">
                                        Pengguna dapat memberikan tanggapan.
                                    </span>
                                </span>
                            </label>
                        </div>
