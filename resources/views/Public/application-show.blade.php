    ...
    <main class="min-h-screen pt-20">
        ...
        @else
            ...
            @if ($isOlderVersion && $preferredVersion)
                <div class="px-4 pt-5 sm:px-6 lg:px-10">
                    <div class="rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex items-start gap-3">
                                <i class="bi bi-exclamation-triangle mt-0.5 text-amber-700"></i>

                                <div>
                                    <p class="font-semibold text-amber-950">
                                        Anda sedang melihat dokumentasi versi lama.
                                    </p>

                                    <p class="mt-1 text-sm text-amber-800">
                                        Versi terbaru yang tersedia adalah
                                        v{{ $preferredVersion->version_number }}.
                                    </p>
                                </div>
                            </div>
                            ...
                            <a
                                ...
                                class="inline-flex shrink-0 items-center justify-center rounded-lg bg-amber-900 px-4 py-2.5 text-sm font-semibold text-white no-underline transition hover:bg-amber-950"
                            >
                                Lihat Versi Terbaru
                            </a>
                        </div>
